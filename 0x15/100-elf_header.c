...
/**
 * check_elf - function to Checks an ELF file
...
/**
 * print_magic - function to prints the magic numbers
...
/**
 * print_class - Function to Prints the class
...
/**
 * print_data - function to Prints data of an ELF header
 * @e_i: pointer to the ELF class
 *
...
/**
 * print_version - function to Prints the version an ELF header
